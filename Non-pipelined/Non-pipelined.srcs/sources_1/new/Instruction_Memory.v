...
// BUBBLE SORT
        ...
        memory[3] = 8'b00000110; // addi x2 0 96     
        memory[4] = 8'b00010011;
        memory[5] = 8'b00000101;
        memory[6] = 8'b00000000;
        memory[7] = 8'b00010000; // addi x10 x0 256
        memory[8] = 8'b10010011;
        memory[9] = 8'b00000101;
        memory[10] = 8'b01110000;
        memory[11] = 8'b00000000; // addi x11 x0 7
        memory[12] = 8'b10010011;
        memory[13] = 8'b00001001;
        memory[14] = 8'b00000000;
        memory[15] = 8'b00000000; // addi x19 x0 0
        memory[16] = 8'b10010011;
        memory[17] = 8'b10001010;
        memory[18] = 8'b11110101;
        memory[19] = 8'b11111111; // addi x21 x11 -1
        memory[20] = 8'b00010011; 
        memory[21] = 8'b00001010;
        memory[22] = 8'b00000000;
        memory[23] = 8'b00000000; // addi x20 x0 0 
        memory[24] = 8'b00010011;
        memory[25] = 8'b00000001;
        memory[26] = 8'b01000001;
        memory[27] = 8'b11111111; // addi x2 x2 -12
        memory[28] = 8'b00100011;
        memory[29] = 8'b00110100;
        memory[30] = 8'b00100001;
        memory[31] = 8'b00000001; // sd x18 8(x2)
        memory[32] = 8'b00100011;
        memory[33] = 8'b00110010;
        memory[34] = 8'b10010001;
        memory[35] = 8'b00000000; // sd x9 4(x2)
        memory[36] = 8'b00100011;
        memory[37] = 8'b00110000;
        memory[38] = 8'b10000001;
        memory[39] = 8'b00000000; // sd x8 0(x2)
        memory[40] = 8'b00010011;
        memory[41] = 8'b00010100;
        memory[42] = 8'b00101010;
        memory[43] = 8'b00000000; // slli x8 x20 2
        memory[44] = 8'b00110011;
        memory[45] = 8'b00000100;
        memory[46] = 8'b10100100;
        memory[47] = 8'b00000000; // add x8 x8 x10 
        memory[48] = 8'b10000011;
        memory[49] = 8'b00110100;
        memory[50] = 8'b00000100;
        memory[51] = 8'b00000000; // ld x9 0(x8)
        memory[52] = 8'b00000011;
        memory[53] = 8'b00111001;
        memory[54] = 8'b01000100;
        memory[55] = 8'b00000000; // ld x18 4(x8)
        memory[56] = 8'b01100011;
        memory[57] = 8'b11000110;
        memory[58] = 8'b00100100;
        memory[59] = 8'b00000001; // blt x9 x18 12
        memory[60] = 8'b00100011;
        memory[61] = 8'b00110010;
        memory[62] = 8'b10010100;
        memory[63] = 8'b00000000; // sd x9 4(x8)
        memory[64] = 8'b00100011;
        memory[65] = 8'b00110000;
        memory[66] = 8'b00100100;
        memory[67] = 8'b00000001; // sd x18 0(x8)
        memory[68] = 8'b00000011;
        memory[69] = 8'b00110100;
        memory[70] = 8'b00000001;
        memory[71] = 8'b00000000; // ld x8 0(x2)
        memory[72] = 8'b10000011;
        memory[73] = 8'b00110100;
        memory[74] = 8'b01000001;
        memory[75] = 8'b00000000; // ld x9 4(x2)
        memory[76] = 8'b00000011;
        memory[77] = 8'b00111001;
        memory[78] = 8'b10000001;
        memory[79] = 8'b00000000; // ld x18 8(x2)
        memory[80] = 8'b00010011;
        memory[81] = 8'b00000001;
        memory[82] = 8'b11000001;
        memory[83] = 8'b00000000; // addi x2 x2 12
        memory[84] = 8'b00010011;
        memory[85] = 8'b00001010;
        memory[86] = 8'b00011010;
        memory[87] = 8'b00000000; // addi x20 x20 1
        memory[88] = 8'b11100011;
        memory[89] = 8'b01000000;
        memory[90] = 8'b01011010;
        memory[91] = 8'b11111101; // blt x20 x21 -64
        memory[92] = 8'b10010011;
        memory[93] = 8'b10001001;
        memory[94] = 8'b00011001;
        memory[95] = 8'b00000000; // addi x19 x19 1 
        memory[96] = 8'b11100011;
        memory[97] = 8'b11001010;
        memory[98] = 8'b10111001;
        memory[99] = 8'b11111010; // blt x19 x11 -76
