...
module RISC_V_Processor(input reset, input clk);
    ...
    IF_ID_Reg if_id_reg (clk, reset, PC_Out, next_instruction, idPC_Out, instruction);
    //end of first stage
    ...
    ID_EX_Reg id_ex_reg (clk, reset, ALUOp, ALUSrc, MemRead, MemWrite, branch, branchOp, MemToReg, RegWrite, idPC_Out, ReadData1, ReadData2, imm_data, rd, rs1, rs2, instruction[30], instruction[14:12], exALUOp, exALUSrc, exMemRead, exMemWrite, exBranch, exBranchOp, exMemToReg, exRegWrite, exPC_Out, exReadData1, exReadData2, exImm_data, exRd, exRs1, exRs2, exInstruction30, exInstruction14_12);
    // end of second stage
    ...
    EX_MEM_Reg ex_mem_reg (clk, reset, exMemRead, exMemWrite, exBranch, exBranchOp, exMemToReg, exRegWrite, out2, fB_out, Result, Zero, Less, exRd, memReadData2, memPC_Out, memResult, memRd, memZero, memLess, memMemRead, memMemWrite, memBranch, memBranchOp, memMemToReg, memRegWrite);
    //end of third stage
